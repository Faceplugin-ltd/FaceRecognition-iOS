...
final class ViewController: UIViewController {
    ...
    private let licenseKey =
        "FP1."
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            stack.bottomAnchor.constraint(equalTo: warningLabel.topAnchor, constant: -12),
            ...
            warningLabel.bottomAnchor.constraint(equalTo: brandButton.topAnchor, constant: -8),
    ...
    private func activateSDK() {
        ...
        FaceRecognitionClient.shared.activate(license: licenseKey) { [weak self] code in
            ...
            if self.sdkReady {
                ...
                let label = FaceRecognitionClient.shared.getLicenseStatus().label
